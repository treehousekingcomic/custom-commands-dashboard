...
@command.route("/server/<int:server_id>/create/removerole", methods=["POST", "GET"])
@requires_authorization
def create_removerole(server_id):
    ...
    if request.method == "GET":
        template = get_template(
            ...
            server,
            data,
            template_name="app/command/removerole",
            variables=variables,
            roles=roles,
        )
